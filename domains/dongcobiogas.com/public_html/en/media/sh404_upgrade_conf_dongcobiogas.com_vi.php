...
// 2.4.4.1017
// saved at: 2012-11-30 19:35:44
// by: admin (id: 62 )
// domain: http://dongcobiogas.com/vi
...
$shInsertNumericalIdCatList = array("17","18","19","20","24","22","32","25","26","27","28","29","33","34","35","36","37","38","39");
...
$defaultComponentStringList = array("content"=>"","banners"=>"","ckeditor"=>"","contact"=>"","gantry"=>"","mailto"=>"","newsfeeds"=>"","poll"=>"","rokcommon"=>"","roknavmenubundle"=>"","rsform"=>"","search"=>"","user"=>"","vvisit_counter"=>"","weblinks"=>"","wrapper"=>"");
